...
void main() {
  runApp(Airport_Registration());
}

class Airport_Registration extends StatelessWidget {
  const Airport_Registration({super.key});
        ...
        child: Column(
          children: [
            Container(
              ...
              child: Image.asset(
                'assets/images/aeropuerto.png', // Asegúrate de que la imagen esté en la ruta correcta
                width: 250,
                height: 250,
                fit: BoxFit.cover,
              ),
