            ...
            children: [
              ...
              ListTile(
                ...
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => FlightManagement()),
                  );
                },
              ),
            ],
            ...
            children: [
              ListTile(
                ...
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => AirportRegistration()),
                  );
                },
              ),
            ],
...
// Implementación de UserRegistration
class UserRegistration extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Registrar Pasajero"),
      ),
      body: Center(
        child: Text("Formulario de Registro de Pasajeros"),
      ),
    );
  }
}

// Implementación de AirportRegistration
class AirportRegistration extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Registrar Aeropuerto"),
      ),
      body: Center(
        child: Text("Formulario de Registro de Aeropuertos"),
      ),
    );
  }
}

// Implementación de FlightSearch
class FlightSearch extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Center(
        child: Text("Formulario de Búsqueda de Vuelos"),
      ),
    );
  }
}

// Implementación de ViewFlightHistory
class ViewFlightHistory extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Historial de Vuelos"),
      ),
      body: Center(
        child: Text("Historial de Vuelos"),
      ),
    );
  }
}