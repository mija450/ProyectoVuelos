      ...
      child: ListView(
        ...
        children: [
            ...
            children: [
              ListTile(
                ...
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => Airport_Registration()),
                  );
                },
              ),
            ],
          ...
          ExpansionTile(
            ...
            children: [
              ListTile(
                leading: Icon(Icons.bookmark_add, color: Colors.grey),
                title: Text("Registrar Reservas"),
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => Reservas_Registration()),
                  );
                },
              ),
            ],
...
class _FlightRegistrationState extends State<FlightRegistration> {
  ...
  Future<void> _selectDateTime(TextEditingController controller) async {
    ...
    if (pickedDate != null) {
      ...
      if (pickedTime != null) {
        setState(() {
          controller.text = "${pickedDate.year}-${pickedDate.month.toString().padLeft(2, '0')}-${pickedDate.day.toString().padLeft(2, '0')} ${pickedTime.hour}:${pickedTime.minute.toString().padLeft(2, '0')}:00";
        });
      }
    }
  }
